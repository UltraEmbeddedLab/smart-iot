...
final class Edit extends Component
{
    ...
    {
        abort_unless($trigger->user_id === Auth::id(), 403);

        $this->trigger = $trigger;
        $this->name = $trigger->name;
        $this->cloudVariableId = $trigger->cloud_variable_id;
        $this->operator = $trigger->operator->value;
        $this->value = $trigger->value;
        $this->actionType = $trigger->action_type->value;
        $this->actionConfig = $trigger->action_config ?? [];
        $this->cooldownSeconds = $trigger->cooldown_seconds;
    }
    ...
    public function updateTrigger(): void
    {
        ...
        Flux::toast(text: 'The trigger has been updated.', heading: 'Trigger updated', variant: 'success');
    ...
    {
        return view('livewire.triggers.edit');
    }
